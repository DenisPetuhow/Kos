...
namespace
{
    ...
    {
        ManipTerrainCallback(EarthManip* manip) : _manip(manip) { }
        void onTileAdded(const TileKey& key, osg::Node* tile, TerrainCallbackContext& context)
        {
            osg::ref_ptr<EarthManip> safe;
            if ( _manip.lock(safe) )
            {
                safe->handleTileAdded(key, tile, context);
            }
        }
        osg::observer_ptr<EarthManip> _manip;
    };
}



EarthManip::Action::Action( ActionType type, const ActionOptions& options ) :
_type( type ),
_options( options )
{
    init();
...
EarthManip::Action::Action( ActionType type ) :
_type( type )
{
    init();
}
...
EarthManip::Action::Action( const Action& rhs ) :
_type( rhs._type ),
_dir( rhs._dir ),
...
bool
EarthManip::Action::getBoolOption( int option, bool defaultValue ) const
{
...
int
EarthManip::Action::getIntOption( int option, int defaultValue ) const
{
    for(ActionOptions::const_iterator i = _options.begin(); i != _options.end(); i++ ) {
        if ( i->option() == option )
            return i->intValue();
...
double
EarthManip::Action::getDoubleOption( int option, double defaultValue ) const
{
    for(ActionOptions::const_iterator i = _options.begin(); i != _options.end(); i++ ) {
        if ( i->option() == option )
...
EarthManip::Action EarthManip::NullAction( EarthManip::ACTION_NULL );
...
EarthManip::Settings::Settings( const EarthManip::Settings& rhs ) :
osg::Referenced( rhs ),
Revisioned     ( rhs ),
...
void
EarthManip::Settings::apply(osg::ArgumentParser& args)
{
    bool   boolval;
    double doubleval;
...
void
EarthManip::Settings::expandSpec( const InputSpec& input, InputSpecs& output ) const
{
...
void
EarthManip::Settings::bind( const InputSpec& spec, const Action& action )
{
    InputSpecs specs;
...
void
EarthManip::Settings::bindMouse(ActionType actionType,
...
void
EarthManip::Settings::bindMouseClick(ActionType action,
                                           int button_mask, int modkey_mask,
                                           const ActionOptions& options)
{
    bind(
...
void
EarthManip::Settings::bindMouseDoubleClick(ActionType action,
                                                 int button_mask, int modkey_mask,
                                                 const ActionOptions& options)
{
    bind(
...
void
EarthManip::Settings::bindKey(ActionType action,
...
void
EarthManip::Settings::bindScroll(ActionType action, int scrolling_motion,
...
void
EarthManip::Settings::bindPinch(ActionType action, const ActionOptions& options)
{
    bind(
        InputSpec( EarthManip::EVENT_MULTI_PINCH, 0, 0 ),
        Action( action, options ) );
}

void
EarthManip::Settings::bindTwist(ActionType action, const ActionOptions& options)
{
    bind(
         InputSpec( EarthManip::EVENT_MULTI_TWIST, 0, 0 ),
         Action( action, options ) );
}

void
EarthManip::Settings::bindMultiDrag(ActionType action, const ActionOptions& options)
{
    bind(
        InputSpec( EarthManip::EVENT_MULTI_DRAG, 0, 0 ),
        Action( action, options ) );
}

const EarthManip::Action&
EarthManip::Settings::getAction(int event_type, int input_mask, int modkey_mask) const
{
...
void
EarthManip::Settings::setMinMaxPitch( double min_pitch, double max_pitch )
{
...
void
EarthManip::Settings::setMaxOffset(double max_x_offset, double max_y_offset)
{
...
void
EarthManip::Settings::setMinMaxDistance( double min_distance, double max_distance)
{
...
void
EarthManip::Settings::setArcViewpointTransitions( bool value )
{
...
void
EarthManip::Settings::setAutoViewpointDurationEnabled( bool value )
{
...
void
EarthManip::Settings::setAutoViewpointDurationLimits( double minSeconds, double maxSeconds )
{
...
EarthManip::EarthManip(osg::ArgumentParser& args) :
osgGA::CameraManipulator()
{
    ctor_init();
    reinitialize();
...
EarthManip::EarthManip( const EarthManip& rhs ) :
...
void
EarthManip::configureDefaultSettings()
{
...
void
EarthManip::applySettings( Settings* settings )
{
    if ( settings )
    {
        _settings = settings;
...
EarthManip::Settings*
EarthManip::getSettings() const
{
    return _settings.get();
}

void
EarthManip::reinitialize()
{
    _distance = 1.0;
    _viewOffset.set(0,0);
...
void
EarthManip::handleTileAdded(const TileKey& key, osg::Node* tile, TerrainCallbackContext& context)
{
...
bool
EarthManip::createLocalCoordFrame( const osg::Vec3d& worldPos, osg::CoordinateFrame& out_frame ) const
{
    if ( _srs.valid() )
    {
        osg::Vec3d mapPos;
...
void
EarthManip::setCenter( const osg::Vec3d& worldPos )
{
    _center = worldPos;
...
void
EarthManip::setNode(osg::Node* node)
{
...
osg::Matrixd
EarthManip::getRotation(const osg::Vec3d& point) const
{
...
osg::Quat
EarthManip::computeCenterRotation(const osg::Vec3d& point) const
{
...
void
EarthManip::setViewpoint(const Viewpoint& vp, double duration_seconds)
{
...
double
EarthManip::setViewpointFrame(double time_s)
{
...
void
EarthManip::setLookAt(const osg::Vec3d& center,
                            double            azim,
                            double            pitch,
                            double            range,
...
bool
EarthManip::isSettingViewpoint() const
{
    return _setVP0.isSet() && _setVP1.isSet();
}

void
EarthManip::cancelViewpointTransition()
{
...
void
EarthManip::setTetherNode(osg::Node* node, double duration_s)
{
...
void
EarthManip::setTetherNode(osg::Node* node,
                                double     duration_s,
...
osg::Node*
EarthManip::getTetherNode() const
{
    if ( !isTethering() )
        return 0L;
...
void EarthManip::collisionDetect()
{
    if (!getSettings()->getTerrainAvoidanceEnabled() ||
        !_srs.valid() )
    {
...
bool
EarthManip::intersect(const osg::Vec3d& start, const osg::Vec3d& end, osg::Vec3d& intersection, osg::Vec3d& normal) const
{
    osg::ref_ptr<MapNode> mapNode;
...
bool
EarthManip::intersectLookVector(osg::Vec3d& out_eye,
...
void
EarthManip::home(double unused)
{
    handleAction( ACTION_HOME, 0, 0, 0 );
}

void
EarthManip::home(const osgGA::GUIEventAdapter& ,osgGA::GUIActionAdapter& us)
{
    home( 0.0 );
    us.requestRedraw();
}
...
void
EarthManip::computeHomePosition()
{
    if( getNode() )
    {
...
void
EarthManip::init(const osgGA::GUIEventAdapter&, osgGA::GUIActionAdapter& )
{
    flushMouseEventStack();
}
...
void
EarthManip::getUsage(osg::ApplicationUsage& usage) const
{
}

void
EarthManip::resetMouse( osgGA::GUIActionAdapter& aa, bool flushEventStack )
{
    if (flushEventStack)
      flushMouseEventStack();
...
void
EarthManip::updateProjection(osg::Camera* eventCamera)
{
...
bool
EarthManip::handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa)
{
    bool handled = false;
...
Viewpoint
EarthManip::getTetherNodeViewpoint() const
{
...
bool
EarthManip::isMouseClick( const osgGA::GUIEventAdapter* mouse_up_event ) const
{
...
void
EarthManip::flushMouseEventStack()
{
    _ga_t1 = NULL;
    _ga_t0 = NULL;
    _touchPointQueue.clear();
...
void
EarthManip::addMouseEvent(const osgGA::GUIEventAdapter& ea)
{
    _ga_t1 = _ga_t0;
    _ga_t0 = &ea;
    _touchPointQueue.clear();
...
void
EarthManip::addTouchEvents(const osgGA::GUIEventAdapter& ea)
{
    _ga_t1 = _ga_t0;
    _ga_t0 = &ea;
...
bool
EarthManip::parseTouchEvents( TouchEvents& output )
{
...
void
EarthManip::setByMatrix(const osg::Matrixd& matrix)
{
    if (!established())
        return;
...
osg::Matrixd
EarthManip::getInverseMatrix() const
{
...
void
EarthManip::updateCamera(osg::Camera& camera)
{
...
void
EarthManip::setByLookAt(const osg::Vec3d& eye,const osg::Vec3d& center,const osg::Vec3d& up)
{
    osg::ref_ptr<osg::Node> safeNode;
    if ( _node.lock(safeNode) )
    {
...
void
EarthManip::setByLookAtRaw(const osg::Vec3d& eye,const osg::Vec3d& center,const osg::Vec3d& up)
{
    // compute rotation matrix
    osg::Vec3d lv(center-eye);
    setDistance( lv.length() );
...
bool
EarthManip::recalculateCenterFromLookVector()
{
...
void
EarthManip::recalculateCenter( const osg::CoordinateFrame& frame )
{
    osg::ref_ptr<osg::Node> node;
    if ( _node.lock(node) )
    {
...
void
EarthManip::pan( double dx, double dy )
{
    if ( !isTethering() )
    {
...
void
EarthManip::rotate( double dx, double dy )
{
...
void
EarthManip::zoom( double dx, double dy )
{
...
bool
EarthManip::screenToWorld(float x, float y, osg::View* theView, osg::Vec3d& out_coords) const
{
...
void
EarthManip::setDistance( double distance )
{
    _distance = osg::clampBetween( distance, _settings->getMinDistance(), _settings->getMaxDistance() );
}

void
EarthManip::dumpActionInfo( const EarthManip::Action& action, osg::NotifySeverity level ) const
{
...
void
EarthManip::handleMovementAction( const ActionType& type, double dx, double dy, osg::View* view )
{
    switch( type )
    {
    case ACTION_PAN:
...
void EarthManip::angleMoveEarth(double angleMove)
{
    _angleMove = angleMove;
}

bool
EarthManip::handlePointAction( const Action& action, float mx, float my, osg::View* view )
{
...
//                GeoPoint position (geoSRS,  point.x(), point.y(), point.z());
//                GeoPoint coords;
//                position.transform( mapSRS, coords );
                here.focalPoint()->x()=here.focalPoint()->x()+_angleMove*180/M_PI;
...
void
EarthManip::handleContinuousAction( const Action& action, osg::View* view )
{
...
void
EarthManip::applyOptionsToDeltas( const Action& action, double& dx, double& dy )
{
...
bool
EarthManip::handleMouseAction( const Action& action, osg::View* view )
{
...
bool
EarthManip::handleMouseClickAction( const Action& action )
{
    //TODO.
    return false;
}
...
bool
EarthManip::handleKeyboardAction( const Action& action, double duration )
{
    double dx = 0, dy = 0;
...
bool
EarthManip::handleScrollAction( const Action& action, double duration )
{
...
bool
EarthManip::handleAction( const Action& action, double dx, double dy, double duration )
{
    bool handled = true;
...
void
EarthManip::getCompositeEulerAngles( double* out_azim, double* out_pitch ) const
{
...
void
EarthManip::getEulerAngles(const osg::Quat& q, double* out_azim, double* out_pitch) const
{
    osg::Matrix m( q );
...
osg::Quat
EarthManip::getQuaternion(double azim, double pitch) const
{
...
void
EarthManip::collapseTetherRotationIntoRotation()
{
...
void
EarthManip::setHomeViewpoint( const Viewpoint& vp, double duration_s )
{
    _homeViewpoint = vp;
...
// rotation. EarthManip represents the placement matrix as the
...
void
EarthManip::drag(double dx, double dy, osg::View* theView)
{
    osgViewer::View* view = dynamic_cast<osgViewer::View*>(theView);
    if ( !view )
        return;
