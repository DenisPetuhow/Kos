...
QT_MOC_LITERAL(1, 19, 13), // "requestRedraw"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "qmapcontrol::Layer\0requestRedraw\0"
};
...
void qmapcontrol::Layer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Layer::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Layer::requestRedraw)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void qmapcontrol::Layer::requestRedraw()const
{
    QMetaObject::activate(const_cast< qmapcontrol::Layer *>(this), &staticMetaObject, 0, nullptr);
}
QT_WARNING_POP
