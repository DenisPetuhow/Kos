...
//qDebug()<<"WIDGET== m_base_zoom="<<m_base_zoom<<"controller_zoom="<<controller_zoom<<"m_widget="<<m_widget->size();
//qDebug()<<"WIDGET== size="<<m_base_size_px.width()<<m_base_size_px.width();
        // Do we have a pixmap?
