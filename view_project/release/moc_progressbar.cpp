...
QT_MOC_LITERAL(3, 23, 2) // "tt"

    },
    "CProgressBar\0setValue\0\0tt"
};
...
void CProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CProgressBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CProgressBar::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_CProgressBar.data,
    qt_meta_data_CProgressBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
