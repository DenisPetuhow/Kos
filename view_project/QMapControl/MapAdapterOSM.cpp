...
//        : MapAdapterTile(QUrl("http://tile.openstreetmap.org/%zoom/%x/%y.png"), supportedProjections(), 0, 17, 0, false, parent) /// @todo remove once MSVC supports initializer lists.
        : MapAdapterTile(QUrl("file:///C:/SAT/z%zoom/0/x%/0/y%.png"), supportedProjections(), 0, 10, 0, false, parent)
    //  : MapAdapterTile(QUrl(path), supportedProjections(), 0, 17, 0, false, parent)
    {
    //QString dirs=dir+"/z%1/0/x%2/0/y%3.jpg";
       // m_path=path;
    }
}
