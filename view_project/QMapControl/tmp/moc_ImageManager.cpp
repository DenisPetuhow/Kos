...
QT_MOC_LITERAL(1, 26, 13), // "downloadImage"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 3), // "url"
QT_MOC_LITERAL(4, 45, 21), // "downloadingInProgress"
QT_MOC_LITERAL(5, 67, 5), // "count"
QT_MOC_LITERAL(6, 73, 19), // "downloadingFinished"
QT_MOC_LITERAL(7, 93, 12), // "imageUpdated"
QT_MOC_LITERAL(8, 106, 15), // "imageDownloaded"
QT_MOC_LITERAL(9, 122, 6) // "pixmap"

    },
    "qmapcontrol::ImageManager\0downloadImage\0"
    "\0url\0downloadingInProgress\0count\0"
    "downloadingFinished\0imageUpdated\0"
    "imageDownloaded\0pixmap"
};
...
void qmapcontrol::ImageManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ImageManager::*)(const QUrl & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageManager::downloadImage)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ImageManager::*)(const int & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageManager::downloadingInProgress)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageManager::downloadingFinished)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ImageManager::*)(const QUrl & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageManager::imageUpdated)) {
                *result = 3;
                return;
            }
        }
