...
QT_MOC_LITERAL(1, 22, 15), // "geometryClicked"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 15), // "const Geometry*"
QT_MOC_LITERAL(4, 55, 8), // "geometry"
QT_MOC_LITERAL(5, 64, 15), // "positionChanged"
QT_MOC_LITERAL(6, 80, 13) // "requestRedraw"

    },
    "qmapcontrol::Geometry\0geometryClicked\0"
    "\0const Geometry*\0geometry\0positionChanged\0"
    "requestRedraw"
};
...
void qmapcontrol::Geometry::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->positionChanged((*reinterpret_cast< const Geometry*(*)>(_a[1]))); break;
        case 2: _t->requestRedraw(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Geometry::*)(const Geometry * ) const;
        ...
        {
            using _t = void (Geometry::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Geometry::requestRedraw)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void qmapcontrol::Geometry::geometryClicked(const Geometry * _t1)const
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(const_cast< qmapcontrol::Geometry *>(this), &staticMetaObject, 0, _a);
}

// SIGNAL 1
void qmapcontrol::Geometry::positionChanged(const Geometry * _t1)const
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(const_cast< qmapcontrol::Geometry *>(this), &staticMetaObject, 1, _a);
}

// SIGNAL 2
void qmapcontrol::Geometry::requestRedraw()const
{
    QMetaObject::activate(const_cast< qmapcontrol::Geometry *>(this), &staticMetaObject, 2, nullptr);
}
QT_WARNING_POP
